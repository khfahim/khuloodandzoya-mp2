---
title: "Repeats, Elephants, and Donkeys in the 2011-2012 Federal Election Cycle"
...
# calculated the top ten states in which candidates have a more equal distribution of contributions per candidate
...
# created a scatter plot for all top ten states, faceting by state and mapping color to incumbent status
...
# created a scatter plot for all top ten states, faceting by state and mapping color to party affiliation
```
...
# calculated the candidate with the biggest number of votes in each of the top ten states
```
