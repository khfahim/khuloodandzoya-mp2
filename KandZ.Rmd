...
final_dataset_new %>%
  ...
  geom_point() + geom_jitter() + labs(x= "Number of Committees in the State", y= "Total Contributions (log)", size= "Primary Votes", color= "Incumbent Status", title = "Breakdown by Incumbent Status")+ theme_hc()
```

```{r}
final_dataset_new %>%
  ggplot(aes(x = number_com, y = total_contributions, color = party, size = primary_votes)) +
  geom_point() +labs(x= "Number of Committees in the State", y= "Total Contributions", color= "Party Type", size= "Primary Votes", title = "Breakdown by Party Type") + theme_hc()
```
